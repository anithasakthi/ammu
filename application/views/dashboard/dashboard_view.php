<div class="row">
    <div id="dashboard-side" class="span4">
        ...
        <form id="create_todo" class="form-signin" method="post" action="<?=site_url('api/create_todo')?>">
    ...
    <div id="dashboard-main" class="span8">
        <form id="create_note" class="form-signin" method="post" action="<?=site_url('api/create_note')?>">
            <div class="input-append">
